...
export class CarUpdateComponent implements OnInit {
  ...
  colors:Color[]
  car:CarModel
   //car:CarModel={iD:0,description:"",dailyPrice:0,modelYear:"",colorId:0,brandId:0}
  carId:number
  dataLoaded=false
  brands:Brand[]
  constructor(private formBuilder: FormBuilder,
    private carService:CarService,private activatedRoute:ActivatedRoute,private toastrService:ToastrService,private brandService:BrandService,private colorService:ColorService) { }
