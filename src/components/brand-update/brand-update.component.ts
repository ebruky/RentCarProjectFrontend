...
export class BrandUpdateComponent implements OnInit {
  ...
  brandId:number
  dataLoaded=false
  constructor(private activatedRoute:ActivatedRoute,private toastrService:ToastrService,private brandService:BrandService,private formBuilder: FormBuilder) { }
