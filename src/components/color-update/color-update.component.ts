...
export class ColorUpdateComponent implements OnInit {
  ...
  colorId:number
  dataLoaded=false
  constructor(private activatedRoute:ActivatedRoute,private toastrService:ToastrService,private colorService:ColorService,private formBuilder: FormBuilder) { }
